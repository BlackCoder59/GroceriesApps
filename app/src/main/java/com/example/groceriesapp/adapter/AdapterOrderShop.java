...
import com.example.groceriesapp.FilterOrderShop;
...
public class AdapterOrderShop extends RecyclerView.Adapter<AdapterOrderShop.HolderOrderShop> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull  HolderOrderShop holder, int position) {
        ...
        if (orderStatus.equals("In Progress")){
            holder.statusTv.setTextColor(context.getResources().getColor(R.color.color_main_blue));
        }
        else if (orderStatus.equals("Completed")){
            holder.statusTv.setTextColor(context.getResources().getColor(R.color.color_green));
