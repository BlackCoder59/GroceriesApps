            ...
            public void onClick(View v) {
                ...
                if (((ShopDetailsActivity)context).isPromoCodeApplied){
                    ...
                    if (subTotalAfterProductRemove < Double.parseDouble(((ShopDetailsActivity)context).promoMinimumOrderPrice)){
                        ...
                        ((ShopDetailsActivity)context).totalFeeTv.setText("$" + String.format("%.2f", Double.parseDouble(String.format("%.2f", subTotalAfterProductRemove + deliveryFee))));
                    }else {
                        ...
                        ((ShopDetailsActivity)context).totalFeeTv.setText("$" + String.format("%.2f", Double.parseDouble(String.format("%.2f", subTotalAfterProductRemove + deliveryFee - promoPrice))));
                    }
                }
                else{
                    //not applied
                ...
                //after removing item from cart, update
